...
function VirtualizedListBoxRender({variableHeight, isLoading, orientation}: {variableHeight: boolean, isLoading?: boolean, orientation: 'vertical' | 'horizontal'}): JSX.Element {
...
export const VirtualizedListBoxDnd: ListBoxStory = (args) => {
